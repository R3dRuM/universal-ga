...
(function(global) {
  ...
  Analytics.prototype = {
    ...
    initializeEcommerce: function(isEnhancedTracking) {
      var plugin = (isEnhancedTracking) ? 'ec' : 'ecommerce';
      this.isEnhancedEcommerceTracking = isEnhancedTracking;
      this.plugin(plugin);
    },
    ecAddTransaction: function(transaction) {
      ...
      if(this.isEnhancedEcommerceTracking) {
        _set.call(this, 'ec:setAction', 'purchase', transaction);
      } else {
    ...
    ecAddItem: function(productItem) {
      ...
      if(this.isEnhancedEcommerceTracking) {
        _set.call(this, 'ec:addProduct', productItem);
      } else {
    ...
    ecSend: function() {
      if(this.isEnhancedEcommerceTracking) {
        warn('ecSend: enhanced ecommerce tracking is currently active. no need to call this method.');
        return;
      }
    ...
    ecClear: function () {
      if(this.isEnhancedEcommerceTracking) {
        warn('ecClear: enhanced ecommerce tracking is currently active. no need to call this method.');
        return;
      }

      _set.call(this, 'ecommerce:clear');
    },
    ecAddImpression: function(productItem) {
      _set.call(this, 'ec:addImpression', productItem);
    },
    ecSetAction: function(action, options) {
      _set.call(this, 'ec:setAction', action, options);
    },
    ecSetActionCheckout: function(options) {
      _set.call(this, 'ec:setAction', 'checkout', options);
    },
    ecSetActionDetail: function() {
      _set.call(this, 'ec:setAction', 'detail');
    },
    ecAddPromo: function(options) {
      _set.call(this, 'ec:addPromo', options);
    }
  };
